                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="field-1" class="control-label">Nº Registro</label>
                                            ...
                                            <div class="row">
											 <div class="col-md-6">
												 ...
												 <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="field-4" class="control-label">Giro</label>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
																...
																<div class="col-md-6">
																		<div class="form-group">
																			<label for="field-4" class="control-label">Email</label>
																			<input type="mail" name="email" required class="form-control" value="<?php echo $rr['email']; ?>" autocomplete="off">
																		</div>
																	</div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
