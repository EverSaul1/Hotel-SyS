                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                <?php 
                                    ...
                                    <?php 
                                        if(permisos($_SESSION['seguridad'.$_SESSION['cod_user']],'Clientes','1')==true){
                                            echo '  <li><a tabindex="-1" href="../cliente/cobros.php">Admin CXC</a></li>';                                           
                                        }                                       
                                    ?>
                            </ul>
                        </li>
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                ...
                                <?php 
                                 if(permisos($_SESSION['seguridad'.$_SESSION['cod_user']],'Usuarios','1')==true){
                                            echo '  <li><a tabindex="-1" href="../respaldo/backup.php">BACKUP DATOS</a></li>';
                                        }
                                        if(permisos($_SESSION['seguridad'.$_SESSION['cod_user']],'Usuarios','1')==true){
                                            echo '  <li><a tabindex="-1" href="../respaldo/restore.php">RESTORE DATOS</a></li>';
                                        }
                                ?>                           
                            </ul>
                        </li>                       
